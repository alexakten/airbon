...
const StepCard: React.FC<StepCardProps> = ({
  ...
  return (
    <div
      className={`bg-white h-full ${borderClass} justify-between text-left items-start flex flex-col  w-full rounded-xl transform transition duration-300 ease-in-out ${hoverClass}`}
    >
