const ProjectData = [
  ...
  {
    projectID: "4",
    projectName: "Biochar Application",
    projectImage: "/images/project_4.avif",
    projectDescription:
  ...
  {
    projectID: "8",
    projectName: "Nutrient Management",
    projectImage: "/images/project_8.avif",
    projectDescription: "Enhanced nutrient management involves optimizing the application of fertilizers and manure to match crop needs, reducing runoff, and minimizing greenhouse gas emissions. Precision agriculture tools are often used to tailor nutrient applications to specific parts of a field, enhancing efficiency and sustainability. This practice not only improves farm productivity but also significantly reduces the environmental impact of farming operations.",
    projectBenefits: "Reduces fertilizer runoff and greenhouse gas emissions; improves farm productivity and sustainability; enhances soil health and crop yields through optimized nutrient application.",
